...
def test_1pu_hex_example():
    ...
    eduardoEphemeralSecretKey = (
        "b5b1158f6fba847407853cdf4bfbcf120412e25918eb15d5a1e7fe04570f6907"
    )
    eduardoEphemeralPublicKey = "04bf4e51d403a9cdfcfa2fe38abf6229db33f59ac14395e92f5b353af213391484f017d3d336f4e03ca974285722641be48d98d5589104ab99abe702fb2bfa6fe2"
    ...
    eduardoKey = derive_sender_1pu(
        eduardoEphemeralSecretKey, eduardoSecretKey, bobPublicKey, alg, apu, apv, keydatalen
    )
    print("Eduardo 1PU key: ", eduardoKey.hex())
    bobKey = derive_receiver_1pu(
        eduardoEphemeralPublicKey, eduardoPublicKey, bobSecretKey, alg, apu, apv, keydatalen
    )
    print("Bob 1PU key: ", bobKey.hex())

    assert eduardoKey == bobKey, "Both parties should generate the same key using ECDH-1PU"
...
def test_1pu_appendix_example():
    ...
    eduardoSecretKey = b64_to_bytes(d, urlsafe=True).hex()
    eduardoPublicKey = (b64_to_bytes(x, urlsafe=True) + b64_to_bytes(y, urlsafe=True)).hex()
    ...
    # Eduardo Ephemeral Key
    d = "0_NxaRPUMQoAJt50Gz8YiTr8gRTwyEaCumd-MToTmIo"
    x = "gI0GAILBdu7T53akrFmMyGcsF3n5dO7MmwNBHKW5SV0"
    y = "SLW_xSffzlPWrHEVI30DHM_4egVwt3NQqeUD7nMFpps"

    eduardoEphemeralSecretKey = b64_to_bytes(d, urlsafe=True).hex()
    eduardoEphemeralPublicKey = (
