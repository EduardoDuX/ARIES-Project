    ...
    "verifiableCredential": [
        {
            ...
            "proof": {
                ...
                "verificationMethod": "PuC7nqM4PnFXHmwQXVbuZ7:3:CL:1255411:usp.agent.degree_schema",
...
W3C_CRED_DEF_ID = "DyZ6N8yDTQsdJazNGRG1Wa:3:CL:1255405:usp.agent.degree_schema"
MOCK_W3C_CRED = {
    "@context": CONTEXT,
    "type": ["VerifiableCredential"],
...
MOCK_W3C_PRES_REQ = {
    ...
    "requested_attributes": {
        "age-verification_attribute": {
            ...
            "restrictions": [
                {
                    "cred_def_id": "XwfxmPHisu4ZeZJBxkU9yG:3:CL:1255397:usp.agent.degree_schema"
                }
            ],
            "non_revoked": None,
        }
...
MOCK_CRED = {
    ...
    "rev_reg_id": None,
    "values": {
        "first_name": {"raw": "Eduardo", "encoded": "113...335"},
