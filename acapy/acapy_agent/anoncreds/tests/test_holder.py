...
from acapy_agent.anoncreds.tests.mock_objects import (
    CRED_DEFS,
    CREDS_W3C_METADATA,
    MOCK_CRED,
    MOCK_CRED_DEF,
...
from acapy_agent.vc.ld_proofs.document_loader import DocumentLoader
from acapy_agent.vc.tests.document_loader import custom_document_loader
...
class MockCredReceived:
    def __init__(self, bad_schema=False, bad_cred_def=False):
        ...
        self.cred_def_id = "Sc886XPwD1gDcHwmmLDeR2:3:CL:229975:usp.agent.degree_schema"
    ...
    cred_def_id = "Sc886XPwD1gDcHwmmLDeR2:3:CL:229975:usp.agent.degree_schema"
    rev_reg_id = None
...
class TestAnonCredsHolder(IsolatedAsyncioTestCase):
    ...
    async def test_store_credential(self, mock_load, mock_master_secret):
        ...
        await self.holder.store_credential(
            ...
            {
                "values": {
                    "First Name": {"raw": "Eduardo", "encoded": "113...335"},
                },
            },
            {"cred-req-meta": "cred-req-meta"},
        )
