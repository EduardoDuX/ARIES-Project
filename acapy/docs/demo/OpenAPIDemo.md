...
Once the Usp agent has started up (with the invite displayed), click the link near the top of the screen `8021`. That will start an instance of the OpenAPI/Swagger user interface connected to the Usp instance. Note that the URL on the OpenAPI/Swagger instance is: `http://ip....8021.direct...`.
...
<details>
    ...
    <img src="collateral/Usp-Agent.png" alt="Swagger Page for Usp Agent">
</details>
...
<details>
    <summary>Show me a screenshot!</summary>
    <img src="collateral/Eduardo-Agent.png" alt="Swagger Page for Eduardo Agent">
</details>
...
To begin running the src in Docker, open up two terminal windows, one each for Usp’s and Eduardo’s agent.
...
<details>
    <summary>Show me a screenshot!</summary>
    <img src="collateral/Usp-Agent-Local.png" alt="Swagger Page for Usp Agent">
</details>
...
<details>
    <summary>Show me a screenshot!</summary>
    <img src="collateral/Eduardo-Agent-Local.png" alt="Swagger Page for Eduardo Agent">
</details>
...
In the Usp browser tab, navigate to the **`POST /connections/create-invitation`** endpoint. Replace the sample body with and empty production (`{}`) and execute the call. If successful, you should see a connection id, an invitation, and the invitation URL. The connection ids will be different on each run.
...
<details>
    ...
    <img src="collateral/1-Usp-Invitation-1.png" alt="Create Invitation Request">
</details>

<details>
    <summary>Show me a screenshot - Create Invitation Response</summary>
    <img src="collateral/1-Usp-Invitation-2.png" alt="Create Invitation Response">
</details>
...
<details>
    <summary>Show me a screenshot - Create Invitation Response</summary>
    <img src="collateral/1-Usp-Invitation-3.png" alt="Create Invitation Response">
</details>
...
<details>
    <summary>Show me a screenshot - Usp Connection Status</summary>
    <img src="collateral/1-Usp-Invitation-4.png" alt="Usp Connection Status">
</details>
...
<details>
    ...
    <img src="collateral/2-Eduardo-Invitation-1.png" alt="Receive Invitation Request">
</details>

<details>
    <summary>Show me a screenshot - Receive Invitation Response</summary>
    <img src="collateral/2-Eduardo-Invitation-2.png" alt="Receive Invitation Request">
</details>
...
<details>
    <summary>Show me a screenshot</summary>
    <img src="collateral/2-Eduardo-Invitation-3.png" alt="Invitation Status">
</details>
...
<details>
    ...
    <img src="collateral/2-Eduardo-Invitation-4.png" alt="Receive Invitation Request">
</details>

<details>
    <summary>Show me a screenshot - Accept Invitation Response</summary>
    <img src="collateral/2-Eduardo-Invitation-5.png" alt="Receive Invitation Response">
</details>
...
<details>
    ...
    <img src="collateral/3-Usp-Connection-2.png" alt="Connection Request Event">
</details>
...
<details>
    ...
    <img src="collateral/3-Usp-Connection-3.png" alt="Accept Connection Request">
</details>

<details>
    <summary>Show me a screenshot - Accept Connection Request</summary>
    <img src="collateral/3-Usp-Connection-4.png" alt="Accept Connection Request">
</details>
...
<details>
    <summary>Show me a screenshot - Eduardo Connection Status</summary>
    <img src="collateral/4-Eduardo-Connection-2.png" alt="Eduardo Connection Event">
</details>
...
<details>
    <summary>Show me the event</summary>
    <img src="collateral/4-Eduardo-Connection-1.png" alt="Eduardo Connection Status">
</details>
...
<details>
    <summary>Show me a screenshot - Usp Connection Status</summary>
    <img src="collateral/5-Usp-Connection-1.png" alt="Usp Connection Status">
</details>
...
### Sending a message from Eduardo to Usp
...
<details>
    <summary>Show me a screenshot</summary>
    <img src="collateral/6-Eduardo-Basic-Msg.png" alt="Eduardo Send Message">
</details>
...
<details>
    <summary>Show me a screenshot</summary>
    <img src="collateral/7-Usp-Basic-Msg.png" alt="Usp Receive Message">
</details>
...
<details>
    <summary>Show me a screenshot</summary>
    <img src="collateral/8-Eduardo-Basic-Msg.png" alt="Eduardo Receive Message Confirmation">
</details>
...
<details>
    <summary>Show me a screenshot</summary>
    <img src="collateral/C-1-Usp-DID-Public.png" alt="Usp Public DID">
</details>
...
<details>
    <summary>Show me a screenshot</summary>
    <img src="collateral/C-2-Usp-Ledger-Search-0.png" alt="Search Ledger by DID">
</details>
...
<details>
    ...
    <img src="collateral/C-2-Usp-Ledger-Search-1.png" alt="DID Transaction">
    <img src="collateral/C-2-Usp-Ledger-Search-2.png" alt="DID Endpoint Transaction">
    <img src="collateral/C-2-Usp-Ledger-Search-3.png" alt="Schema Transaction">
    <img src="collateral/C-2-Usp-Ledger-Search-4.png" alt="Credential Definition Transaction">
</details>
...
<details>
    <summary>Show me a screenshot</summary>
    <img src="collateral/C-3-Usp-Info-2.png" alt="Search Schemas">
    <img src="collateral/C-3-Usp-Info-3.png" alt="Search Schemas">
</details>
...
<details>
    <summary>Show me a screenshot</summary>
    <img src="collateral/C-3-Usp-Info-4.png" alt="Search Credential Definitions">
    <img src="collateral/C-3-Usp-Info-5.png" alt="Search Credential Definitions">
</details>
...
<details>
    ...
    <img src="collateral/C-3-Usp-Info-1.png" alt="Connection Id">
</details>
...
<details>
    ...
    <img src="collateral/C-4-Usp-Credential-Offer-1.png" alt="Usp Submit Credential Offer">
    <img src="collateral/C-4-Usp-Credential-Offer-2.png" alt="Usp Submit Credential Offer">
</details>
...
<details>
    ...
    <img src="collateral/C-5-Eduardo-Credential-Offer-1.png" alt="Issue Credential">
</details>
...
<details>
    ...
    <img src="collateral/C-7-Eduardo-Store-Credential-1.png" alt="">
    <img src="collateral/C-7-Eduardo-Store-Credential-2.png" alt="">
</details>
...
<details>
    ...
    <img src="collateral/C-7-Eduardo-Store-Credential-3.png" alt="">
    <img src="collateral/C-7-Eduardo-Store-Credential-4.png" alt="">
</details>
...
<details>
    <summary>Show me Usp's event activity</summary>
    <img src="collateral/C-6-Usp-Credential-Request.png" alt="">
    <img src="collateral/C-8-Usp-Credential-Ack-0.png" alt="">
</details>
...
<details>
    <summary>Show me a screenshot</summary>
    <img src="collateral/C-8-Usp-Credential-Ack-1.png" alt="">
    <img src="collateral/C-8-Usp-Credential-Ack-2.png" alt="">
</details>
...
<details>
    ...
    <img src="collateral/P-1-Usp-Proof-Request-1.png" alt="Send Proof Request">
    <img src="collateral/P-1-Usp-Proof-Request-2.png" alt="Send Proof Request">
</details>
...
<details>
    <summary>Show me Eduardo's event activity</summary>
    <img src="collateral/P-2-Eduardo-Proof-Request-1.png" alt="Proof Request">
    <img src="collateral/P-2-Eduardo-Proof-Request-2.png" alt="Proof Request">
</details>
...
<details>
    <summary>Show me Usp's event activity</summary>
    <img src="collateral/P-3-Usp-Proof-1.png" alt="Receive and Verify Proof">
    <img src="collateral/P-3-Usp-Proof-2.png" alt="Receive and Verify Proof">
    <img src="collateral/P-3-Usp-Proof-3.png" alt="Receive and Verify Proof">
</details>
...
| Protocol Step        | Usp (Verifier)       | Eduardo (Holder/Prover)     | Notes |
| -------------------- | ---------------------- | ------------------------- | ----- |
