...
- [Developer Demos](#developer-srcs)
- [Running](#running)
...
To put ACA-Py through its paces at the command line, checkout our [srcs](../src/README.md) page.
...
One thing to be aware of is, unlike the src, none of the steps are automated. You will need to create public dids, connections and all the other steps yourself. Using the src and studying the flow and then copying them with your dev container debug session is a great way to learn how everything works.
