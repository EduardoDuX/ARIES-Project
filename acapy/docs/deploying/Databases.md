...
If the wallet is configured the default way in eg. [src-args.yaml](https://github.com/openwallet-foundation/acapy/tree/main/src/src-args.yaml), without explicit wallet-storage, a sqlite database file is used.
