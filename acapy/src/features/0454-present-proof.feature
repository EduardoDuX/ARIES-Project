Feature: RFC 0454 Aries agent present proof
   ...
   Scenario Outline: Present Proof where the prover does not propose a presentation of the proof and is acknowledged
      ...
      And "Usp" and "Bob" have an existing connection
      When "Usp" sends a request for proof presentation <Proof_request> to "Bob"
      Then "Usp" has the proof verified

      @Release @WalletType_Askar
      Examples:
         | issuer | Acme_capabilities                      | Bob_capabilities          | Schema_name       | Credential_data   | Proof_request     |
         | Usp  | --public-did                           |                           | driverslicense_v2 | Data_DL_MaxValues | DL_age_over_19_v2 |
      
      @Release @WalletType_Askar
      Examples:
         | issuer | Acme_capabilities                      | Bob_capabilities          | Schema_name       | Credential_data   | Proof_request     |
         | Usp  | --public-did --did-exchange            | --did-exchange            | driverslicense_v2 | Data_DL_MaxValues | DL_age_over_19_v2 |

      @Release @WalletType_Askar_AnonCreds
      Examples:
         | issuer | Acme_capabilities                      | Bob_capabilities          | Schema_name       | Credential_data   | Proof_request     |
         | Usp  | --public-did --wallet-type askar-anoncreds | --wallet-type askar-anoncreds | driverslicense_v2 | Data_DL_MaxValues | DL_age_over_19_v2 |
      
      @Release @WalletType_Askar_AnonCreds @cred_type_vc_di
      Examples:
         | issuer | Acme_capabilities                      | Bob_capabilities          | Schema_name       | Credential_data   | Proof_request     |
         | Usp  | --public-did --wallet-type askar-anoncreds --cred-type vc_di | --wallet-type askar-anoncreds | driverslicense_v2 | Data_DL_MaxValues | DL_age_over_19_v2 |
      
      @Release @WalletType_Askar_AnonCreds
      Examples:
         | issuer | Acme_capabilities                      | Bob_capabilities          | Schema_name       | Credential_data   | Proof_request     |
         | Usp  | --public-did --wallet-type askar-anoncreds |                               | driverslicense_v2 | Data_DL_MaxValues | DL_age_over_19_v2 |
         | Usp  | --public-did                           | --wallet-type askar-anoncreds | driverslicense_v2 | Data_DL_MaxValues | DL_age_over_19_v2 |
   ...
   Scenario Outline: Present Proof where the prover does not propose a presentation of the proof and is acknowledged
      Given we have "2" agents
         ...
         | Usp | verifier | <Acme_capabilities> | <Acme_extra> |
      ...
      Examples:
         ...
         | Usp  | --public-did --did-exchange --emit-did-peer-2            | | --did-exchange --emit-did-peer-2     | | driverslicense_v2 | Data_DL_MaxValues | DL_age_over_19_v2 |

      @Release @WalletType_Askar_AnonCreds
      Examples:
         | issuer | Acme_capabilities                          | Acme_extra        | Bob_capabilities              | Bob_extra         | Schema_name       | Credential_data   | Proof_request     |
         | Usp  | --public-did --wallet-type askar-anoncreds --emit-did-peer-2 | | --wallet-type askar-anoncreds --emit-did-peer-2 | | driverslicense_v2 | Data_DL_MaxValues | DL_age_over_19_v2 |
   ...
   Scenario Outline: Present Proof json-ld where the prover does not propose a presentation of the proof and is acknowledged
      ...
      And "Usp" and "Bob" have an existing connection
      When "Usp" sends a request for json-ld proof presentation <Proof_request> to "Bob" with <Sig_type>
      Then "Usp" has the proof verified
      ...
      Examples:
         | issuer | Acme_capabilities                               | Bob_capabilities | Schema_name       | Credential_data   | Proof_request     | Key_type   | Sig_type            |
         | Usp  | --public-did --cred-type json-ld --did-exchange | --did-exchange   | driverslicense_v2 | Data_DL_MaxValues | DL_age_over_19_v2 | bls12381g2 | BbsBlsSignature2020 |

      @Release @WalletType_Askar_AnonCreds @BBS
      Examples:
         | issuer | Acme_capabilities                                              | Bob_capabilities              | Schema_name       | Credential_data   | Proof_request     | Key_type   | Sig_type            |
         | Usp  | --public-did --cred-type json-ld --wallet-type askar-anoncreds | --wallet-type askar-anoncreds | driverslicense_v2 | Data_DL_MaxValues | DL_age_over_19_v2 | bls12381g2 | BbsBlsSignature2020 |
   ...
   Scenario Outline: Present Proof where the issuer revokes the credential and the proof fails
      ...
      And "Usp" and "Bob" have an existing connection
      When "Usp" sends a request for proof presentation <Proof_request> to "Bob"
      Then "Usp" has the proof verification fail

      @Release @WalletType_Askar
      Examples:
         | issuer | Acme_capabilities                          | Bob_capabilities | Schema_name       | Credential_data   | Proof_request     |
         | Usp  | --revocation --public-did                  |                  | driverslicense_v2 | Data_DL_MaxValues | DL_age_over_19_v2 |

      @Release @WalletType_Askar
      Examples:
         | issuer | Acme_capabilities                          | Bob_capabilities | Schema_name       | Credential_data   | Proof_request     |
         | Usp  | --revocation --public-did --did-exchange   | --did-exchange   | driverslicense_v2 | Data_DL_MaxValues | DL_age_over_19_v2 |

      @Release @WalletType_Askar_AnonCreds
      Examples:
         | issuer | Acme_capabilities                          | Bob_capabilities | Schema_name       | Credential_data   | Proof_request     |
         | Usp  | --revocation --public-did --wallet-type askar-anoncreds | --wallet-type askar-anoncreds | driverslicense_v2 | Data_DL_MaxValues | DL_age_over_19_v2 |

      @Release @WalletType_Askar_AnonCreds @cred_type_vc_di
      Examples:
         | issuer | Acme_capabilities                          | Bob_capabilities | Schema_name       | Credential_data   | Proof_request     |
         | Usp  | --revocation --public-did --wallet-type askar-anoncreds --cred-type vc_di | --wallet-type askar-anoncreds | driverslicense_v2 | Data_DL_MaxValues | DL_age_over_19_v2 |
   ...
   Scenario Outline: Present Proof for multiple credentials where the one is revocable and one isn't, neither credential is revoked
      Given we have "4" agents
         ...
         | Usp | verifier | <Acme1_capabilities> |
         | Bob   | prover   | <Bob_cap>   |
   ...
   Scenario Outline: Present Proof for multiple credentials where the one is revocable and one isn't, and the revocable credential is revoked, and the proof doesn't check for revocation and passes
      ...
      And "Bob" has an issued <Schema_name_2> credential <Credential_data_2> from "<issuer2>"
      And "Usp" and "Bob" have an existing connection
      When "Usp" sends a request with explicit revocation status for proof presentation <Proof_request> to "Bob"
      Then "Usp" has the proof verified
