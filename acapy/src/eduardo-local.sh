#!/bin/bash
# this runs the Usp example as a local instace of instance of aca-py
...
PYTHONPATH=.. ../bin/aca-py start \
   ...
   --admin-insecure-mode \
   --wallet-type askar \
   --wallet-name eduardo.agent420695 \
   --wallet-key eduardo.agent420695 \
   --preserve-exchange-records \
   --auto-provision \
   --genesis-url http://localhost:9000/genesis \
   --trace-target log \
   --trace-tag acapy.events \
   --trace-label eduardo.agent.trace \
