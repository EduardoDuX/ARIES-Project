...
- Documentation, code formatting, publishing process updates:
  ...
  - Fix links to EduardoGetsAPhone.md from abs to rel and blob refs [\#3128](https://github.com/hyperledger/aries-cloudagent-python/pull/3128) [rngadam](https://github.com/rngadam)
  ...
  - src/ACA-Py-Workshop.md tweak for Traction Sandbox update [\#3136](https://github.com/hyperledger/aries-cloudagent-python/pull/3136) [loneil](https://github.com/loneil)
...
- Dependabot PRs:
  ...
  - chore(deps): Bump pytest-asyncio from 0.23.7 to 0.23.8 in /src/playground/examples [\#3117](https://github.com/hyperledger/aries-cloudagent-python/pull/3117) [dependabot bot](https://github.com/dependabot bot)
  ...
  - chore(deps): Bump certifi from 2024.6.2 to 2024.7.4 in /src/playground/examples in the pip group [\#3084](https://github.com/hyperledger/aries-cloudagent-python/pull/3084) [dependabot bot](https://github.com/dependabot bot)
  ...
  - chore(deps): Bump urllib3 from 2.2.1 to 2.2.2 in /src/playground/examples in the pip group [\#3045](https://github.com/hyperledger/aries-cloudagent-python/pull/3045) [dependabot bot](https://github.com/dependabot bot)
  ...
  - chore(deps): Update prompt-toolkit requirement from ~=2.0.9 to ~=2.0.10 in /src [\#3026](https://github.com/hyperledger/aries-cloudagent-python/pull/3026) [dependabot bot](https://github.com/dependabot bot)
  ...
  - Merge all src dependabot PRs [\#3008](https://github.com/hyperledger/aries-cloudagent-python/pull/3008) [PatStLouis](https://github.com/PatStLouis)
  ...
  - chore(deps): Bump hyperledger/aries-cloudagent-python from py3.9-0.9.0 to py3.9-0.12.1 in /src/multi-src [\#2976](https://github.com/hyperledger/aries-cloudagent-python/pull/2976) [dependabot bot](https://github.com/dependabot bot)
  - chore(deps): Bump hyperledger/aries-cloudagent-python from py3.9-0.10.4 to py3.9-0.12.1 in /src/playground [\#2975](https://github.com/hyperledger/aries-cloudagent-python/pull/2975) [dependabot bot](https://github.com/dependabot bot)
  - chore(deps): Bump hyperledger/aries-cloudagent-python from py3.9-0.9.0 to py3.9-0.12.1 in /src/docker-agent [\#2973](https://github.com/hyperledger/aries-cloudagent-python/pull/2973) [dependabot bot](https://github.com/dependabot bot)
  ...
  - chore(deps): Bump untergeek/curator from 8.0.2 to 8.0.15 in /src/elk-stack/extensions/curator [\#2969](https://github.com/hyperledger/aries-cloudagent-python/pull/2969) [dependabot bot](https://github.com/dependabot bot)
...
- Test and Demo updates:
  - fix Usp src to use oob with aip10 to support connection reuse [\#2903](https://github.com/hyperledger/aries-cloudagent-python/pull/2903) [ianco](https://github.com/ianco)
...
- Dependencies and Internal Updates:
  ...
  - chore(deps): Bump idna from 3.4 to 3.7 in /src/playground/examples  dependencies python [\#2886](https://github.com/hyperledger/aries-cloudagent-python/pull/2886) [dependabot bot](https://github.com/dependabot bot)
...
- Other Fixes, Demo, DevContainer and Documentation Fixes
  ...
  - Update to run_src script to support Apple M1 CPUs [\#2843](https://github.com/hyperledger/aries-cloudagent-python/pull/2843) [swcurran](https://github.com/swcurran)
...
- Dependencies and Internal Updates
  ...
  - fix: update broken src dependency [\#2638](https://github.com/hyperledger/aries-cloudagent-python/pull/2638) [mrkaurelius](https://github.com/mrkaurelius)
...
- Other Fixes, Demo, DevContainer and Documentation Fixes
  ...
  - Update src/playground scripts [\#2562](https://github.com/hyperledger/aries-cloudagent-python/pull/2562) [usingtechnology](https://github.com/usingtechnology)
...
- Dependencies and Internal Updates
  ...
  - chore(deps): Bump urllib3 from 2.0.6 to 2.0.7 in /src/playground/scripts  dependencies [\#2551](https://github.com/hyperledger/aries-cloudagent-python/pull/2551) [dependabot bot](https://github.com/dependabot)
  ...
  - chore(deps): Bump urllib3 from 2.0.2 to 2.0.6 in /src/playground/scripts  dependencies [\#2524](https://github.com/hyperledger/aries-cloudagent-python/pull/2524) [dependabot bot](https://github.com/dependabot)
...
- Dependencies and Internal Updates
  - chore(deps): Bump certifi from 2023.5.7 to 2023.7.22 in /src/playground/scripts dependencies [\#2354](https://github.com/hyperledger/aries-cloudagent-python/pull/2354) [dependabot bot](https://github.com/dependabot)
...
- Credential Exchange (Issue, Present) Updates
  - Add revocation registry rotate to usp src [\#2333](https://github.com/hyperledger/aries-cloudagent-python/pull/2333) [usingtechnology](https://github.com/usingtechnology)
...
- Other Fixes, Demo, and Documentation Fixes
  ...
  - Fix eduardo/usp src execution [\#2305](https://github.com/hyperledger/aries-cloudagent-python/pull/2305) [andrewwhitehead](https://github.com/andrewwhitehead)
  ...
  - Add build step for indy-base image in run_src [\#2299](https://github.com/hyperledger/aries-cloudagent-python/pull/2299) [usingtechnology](https://github.com/usingtechnology)
...
- Dependencies and Internal Updates
  ...
  - chore(deps): Bump aiohttp from 3.8.4 to 3.8.5 in /src/playground/scripts dependencies [\#2325](https://github.com/hyperledger/aries-cloudagent-python/pull/2325) [dependabot bot](https://github.com/dependabot)
  - ⬆️ upgrade marshmallow to latest [\#2322](https://github.com/hyperledger/aries-cloudagent-python/pull/2322) [ff137](https://github.com/ff137)
...
- Multi-tenancy fixes/updates
  ...
  - Fix multitenant/mediation in src [\#2075](https://github.com/hyperledger/aries-cloudagent-python/pull/2075) [ianco](https://github.com/ianco)
- Other Bug and Documentation Fixes
  ...
  - ./run_src performance -c 1 --mediation --timing --trace-log [#2245](https://github.com/hyperledger/aries-cloudagent-python/pull/2245) [usingtechnology](https://github.com/usingtechnology)
  - Fix formatting and grammatical errors in different readme's [\#2222](https://github.com/hyperledger/aries-cloudagent-python/pull/2222) [ff137](https://github.com/ff137)
  - Fix broken link in README [\#2221](https://github.com/hyperledger/aries-cloudagent-python/pull/2221) [ff137](https://github.com/ff137)
  ...
  - Update Eduardo Wants a JSON-LD Credential to fix invocation [\#2219](https://github.com/hyperledger/aries-cloudagent-python/pull/2219) [swcurran](https://github.com/swcurran)
- Dependencies and Internal Updates
  - Bump requests from 2.30.0 to 2.31.0 in /src/playground/scripts dependenciesPull requests that update a dependency file [\#2238](https://github.com/hyperledger/aries-cloudagent-python/pull/2238) [dependabot bot](https://github.com/dependabot)
  - Upgrade codegen tools in scripts/generate-open-api-spec and publish Swagger 2.0 and OpenAPI 3.0 specs [\#2246](https://github.com/hyperledger/aries-cloudagent-python/pull/2246) [ff137](https://github.com/ff137)
- ACA-Py Administrative Updates
...
- Message Tracing/Timing Updates
  - Add updated ELK stack for srcs. [\#2236](https://github.com/hyperledger/aries-cloudagent-python/pull/2236) [usingtechnology](https://github.com/usingtechnology)
- Release management pull requests
...
- Hyperledger Indy Endorser/Author Transaction Handling
  - Update some of the src Readme and Endorser instructions [\#2122](https://github.com/hyperledger/aries-cloudagent-python/pull/2122) [swcurran](https://github.com/swcurran)
...
- Dependency, Python version, GitHub Actions and Container Image Changes
  ...
  - Previously flagged in release 1.0.0-rc1
    ...
    - Fix: web.py dependency - integration tests & srcs [\#1973](https://github.com/hyperledger/aries-cloudagent-python/pull/1973) ([shaangill025](https://github.com/shaangill025))
...
- Demo and Documentation Updates
  ...
  - Fix typos in eduardo-local.sh & usp-local.sh [\#2010](https://github.com/hyperledger/aries-cloudagent-python/pull/2010) ([naonishijima](https://github.com/naonishijima))
  ...
  - Doc updates for json src [\#2026](https://github.com/hyperledger/aries-cloudagent-python/pull/2026) ([ianco](https://github.com/ianco))
  - Multitenancy src \(docker-compose with postgres and ngrok\) [\#2089](https://github.com/hyperledger/aries-cloudagent-python/pull/2089) ([ianco](https://github.com/ianco))
  ...
  - Previously flagged in release 1.0.0-rc1
    ...
    - Fixed bug in run\_src script [\#1982](https://github.com/hyperledger/aries-cloudagent-python/pull/1982) ([pasquale95](https://github.com/pasquale95))
    - Transaction Author with Endorser src [\#1975](https://github.com/hyperledger/aries-cloudagent-python/pull/1975) ([ianco](https://github.com/ianco))
...
and src changes, developer tools and release management updates. All the usual
stuff needed for a healthy, growing codebase.

#### Categorized List of Pull Requests

- Hyperledger Indy Endorser related updates:
  - Fix order of operations connecting usp to endorser [\#1716](https://github.com/hyperledger/aries-cloudagent-python/pull/1716) ([ianco](https://github.com/ianco))
...
- Documentation and Demo Updates
  - Use default wallet type askar for eduardo/usp src and bdd tests [\#1761](https://github.com/hyperledger/aries-cloudagent-python/pull/1761) ([ianco](https://github.com/ianco))
  ...
  - Fixes logic for web hook formatter in Usp src [\#1739](https://github.com/hyperledger/aries-cloudagent-python/pull/1739) ([amanji](https://github.com/amanji))
  ...
  - [\#1674](https://github.com/hyperledger/aries-cloudagent-python/issue/1674) Add basic DOCKER_ENV logging for run_src [\#1675](https://github.com/hyperledger/aries-cloudagent-python/pull/1675) ([tdiesler](https://github.com/tdiesler))
  - Performance src updates [\#1647](https://github.com/hyperledger/aries-cloudagent-python/pull/1647) ([ianco](https://github.com/ianco))
...
- Code management and contributor/developer support updates
  - Set prefix for integration test src agents; some code cleanup [\#1840](https://github.com/hyperledger/aries-cloudagent-python/pull/1840) ([andrewwhitehead](https://github.com/andrewwhitehead))
...
- **AIP 2.0 Features**
  ...
  - Add Revocation notification support to eduardo/usp [#1527](https://github.com/hyperledger/aries-cloudagent-python/pull/1527)
- **Other New Features**
...
- **Documentation Additions and Updates**
  ...
  - The Eduardo/Usp src was updated to allow connections based on Public DIDs to be established, including reusing a connection if there is an existing connection. [#1574](https://github.com/hyperledger/aries-cloudagent-python/pull/1574)
- **Other Fixes**
...
- Indy Transaction Endorser Support Added
  - Endorser protocol configuration, automation and src integration [#1422](https://github.com/hyperledger/aries-cloudagent-python/pull/1422)
...
- Updates/Fixes to the Eduardo/Usp src and integration tests
  ...
  - Fix issue with startup sequence for usp agent [#1415](https://github.com/hyperledger/aries-cloudagent-python/pull/1415)
  - Connectionless proof src [#1395](https://github.com/hyperledger/aries-cloudagent-python/pull/1395)
  - Typos in the src's README.md [#1405](https://github.com/hyperledger/aries-cloudagent-python/pull/1405)
...
- Update revocation src after changes to tails file handling [#644](https://github.com/hyperledger/aries-cloudagent-python/pull/644)
...
- Add src support for tails server [#499](https://github.com/hyperledger/aries-cloudagent-python/pull/499)
...
- Updated documentation for administration API src [#397](https://github.com/hyperledger/aries-cloudagent-python/pull/397)
...
- Update docker image used in src and test containers [#391](https://github.com/hyperledger/aries-cloudagent-python/pull/391)
...
- Tweaks to `run_docker`/`run_src` scripts for Windows [#357](https://github.com/hyperledger/aries-cloudagent-python/pull/357)
...
- Switch performance src to the newer issue-credential protocol [#243](https://github.com/hyperledger/aries-cloudagent-python/pull/243)
...
- Handle connection invitations in base64 or URL format in the Eduardo src agent [#186](https://github.com/hyperledger/aries-cloudagent-python/pull/186)
...
- Fix src presentation request, optimize credential retrieval [#108](https://github.com/hyperledger/aries-cloudagent-python/pull/108)
...
- Further updates to the running locally section of the src README [#86](https://github.com/hyperledger/aries-cloudagent-python/pull/86)
...
- Allow src scripts to run outside of Docker; add command line parsing [#84](https://github.com/hyperledger/aries-cloudagent-python/pull/84)
...
- further cleanup to the OpenAPI src script [#71](https://github.com/hyperledger/aries-cloudagent-python/pull/71)
...
- Updated API src docs to use eduardo/usp scripts [#54](https://github.com/hyperledger/aries-cloudagent-python/pull/54)
- Updates to the readme for the src to add PWD support [#53](https://github.com/hyperledger/aries-cloudagent-python/pull/53)
- Swallow empty input in src scripts [#51](https://github.com/hyperledger/aries-cloudagent-python/pull/51)
...
- Tweak in script to work under Linux; updates to readme for src [#33](https://github.com/hyperledger/aries-cloudagent-python/pull/33)
...
- Eduardo-Usp src update [#28](https://github.com/hyperledger/aries-cloudagent-python/pull/28)
